...
"""
옷 아이템 카테고리는 다음과 같이 있고 고정 값이야. 여기서 더 디테일하게 해줄 필요 없어.
## 의류 카테고리 (각 아이템은 다른 아이템과 어울리는 조합으로 추천해주세요)

### 상의
- 반팔 티셔츠, 긴팔 티셔츠, 카라 티셔츠/폴로, 민소매/나시
- 셔츠
- 니트/스웨터
- 맨투맨, 후드 티셔츠, 후드 집업

### 아우터
- 바람막이/윈드브레이커, 데님 재킷, 카디건
- 가죽 재킷, 정장 재킷/블레이저, 스타디움 재킷, 항공점퍼(블루종), 아노락, 트레이닝 자켓, 사파리 재킷, 조끼/베스트
- 코트, 가벼운 코트, 숏패딩, 롱패딩, 무스탕, 플리스, 패딩 조끼

### 하의
- 청바지/데님, 정장 바지/슬랙스, 면바지, 트레이닝/조거 팬츠
- 반바지
- 레깅스
- 원피스, 스커트, 점프수트/오버올
